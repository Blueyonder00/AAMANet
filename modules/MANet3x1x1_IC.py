...
class MDNet(nn.Module):
    def __init__(self, model_path1=None, K=1, init_weights=True):
        ...
        self.RGB_para1_3x3 = nn.Sequential(OrderedDict([
            ('Rconv1', nn.Sequential(nn.Conv2d(3, 48, kernel_size=3, stride=2),
        ...
        self.RGB_para2_1x1 = nn.Sequential(OrderedDict([
            ('Rconv2', nn.Sequential(nn.Conv2d(96, 128, kernel_size=1, stride=2),
        ...
        self.RGB_para3_1x1 = nn.Sequential(OrderedDict([
            ('Rconv3', nn.Sequential(nn.Conv2d(256, 256, kernel_size=1, stride=2),
        ...
        self.T_para1_3x3 = nn.Sequential(OrderedDict([
            ('Tconv1', nn.Sequential(nn.Conv2d(3, 48, kernel_size=3, stride=2),
        ...
        self.T_para2_1x1 = nn.Sequential(OrderedDict([
            ('Tconv2', nn.Sequential(nn.Conv2d(96, 128, kernel_size=1, stride=2),
        ...
        self.T_para3_1x1 = nn.Sequential(OrderedDict([
            ('Tconv3', nn.Sequential(nn.Conv2d(256, 256, kernel_size=1, stride=2),
        ...
        self.layers = nn.Sequential(OrderedDict([
            ('conv1', nn.Sequential(nn.Conv2d(3, 48, kernel_size=7, stride=2),
                                    nn.ReLU(),#nn.ReLU(),
                                    # LRN(),
                                    nn.BatchNorm2d(48),
                                    nn.MaxPool2d(kernel_size=3, stride=2))),
            ('conv2', nn.Sequential(nn.Conv2d(96, 128, kernel_size=5, stride=2),
                                    nn.ReLU(),#nn.ReLU(),
                                    # LRN(),
                                    nn.BatchNorm2d(128),
                                    nn.MaxPool2d(kernel_size=3, stride=2))),
        ...
        for name, module in self.layers.named_children():
            ...
            if run:
                if name == 'conv1':
                    ...
                    featT = torch.cat((feat_MT,feat_T),1)
                    featR = torch.cat((feat_MR,feat_R),1)
